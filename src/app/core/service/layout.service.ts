...
export interface ILayoutConf {
  ...
  matTheme?: string; // material theme. tgss-blue, tgss-navy, tgss-dark-purple, tgss-dark-pink
...
export class LayoutService {
  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "slate", // http://demos.ui-lib.com/tgss-doc/#tgss-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        dir: "ltr", // ltr, rtl
        useBreadcrumb: true,
        topbarFixed: false,
        footerFixed: false,
        topbarColor: "white", // http://demos.ui-lib.com/tgss-doc/#tgss-colors
        footerColor: "slate", // http://demos.ui-lib.com/tgss-doc/#tgss-colors
        matTheme: "tgss-navy", // tgss-blue, tgss-navy, tgss-light-purple, tgss-dark-purple, tgss-dark-pink
  ...
  setFont(primary: string) {
    if (primary) {
      window.localStorage.setItem(constant().app.config.themeFont, primary);
      document.documentElement.style.setProperty('--primary-font-family', primary);
    }
  }
