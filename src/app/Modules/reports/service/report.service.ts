...
export class ReportService {
  ...
  getInvoice(obj) {
    return this.apiService.post(`invoice/get-invoice-report/pdf`, obj).pipe(map(Positions => {
      return Positions;
    }));
  }
  ...
  create(formData): Observable<FileUpload> {
    return this.apiService.fileUpload(`pdf/post-pdf`, formData).pipe(map(response => (response)));
  }
  // downloadFile(obj) {
