...
@Component({
  selector: 'app-loginandlogout',
  templateUrl: './loginandlogout.component.html',
  styleUrls: ['./loginandlogout.component.scss']
})
export class LoginandlogoutComponent implements OnInit {
  basicForm: FormGroup;
  ...
  displayedColumns: string[] = ['districtId', 'branch', 'mailId', 'logIn', 'logOut'];
  ...
  getReport() {
    ...
    this.userData.getLogIn(obj).subscribe((data) => {
