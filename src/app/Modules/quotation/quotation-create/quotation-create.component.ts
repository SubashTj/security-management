...
export class QuotationCreateComponent implements OnInit {
  ...
  async generatePDF(action = 'open', quotationForm) {
    let docDefinition = {
      // watermark: { text: 'PHS', color: 'blue', opacity: 0.1, bold: true, italics: false },
      background: {
      ...
      content: [
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              [{ text: 'Total Amount', colSpan: 4 }, {}, {}, {}, this.quotationForm.value.items.reduce((sum, p) => sum + (p.workingDuration * p.unitsPerDay), 0).toFixed(2)]
            ]
          }
        },
        {
        ...
        },
        {
          ul: [
            ...
            'This is valid only for specified period of time.',
            'Acknowledge the quotation as soon possible.'
          ],
        }
      ],
      styles: {
